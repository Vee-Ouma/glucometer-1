...
import com.metavision.glucometer.other.IntroManage;

public class IntroActivity extends AppCompatActivity {

    private ViewPager viewPager;
    private IntroManage introManage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introManage = new IntroManage(this);
        if (!introManage.Check()){
            introManage.setFirst(false);
